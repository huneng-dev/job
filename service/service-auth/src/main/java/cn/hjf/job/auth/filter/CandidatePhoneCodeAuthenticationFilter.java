...
public class CandidatePhoneCodeAuthenticationFilter extends UsernamePasswordAuthenticationFilter {

    private final ValidationUtil validationUtil;

    public CandidatePhoneCodeAuthenticationFilter(
        ...
        super.setFilterProcessesUrl("/auth/candidate/phone/code");
