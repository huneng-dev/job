...
public class CandidatePhonePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {

    private final ValidationUtil validationUtil;

    public CandidatePhonePasswordAuthenticationFilter(
        ...
        super.setFilterProcessesUrl("/auth/candidate/phone/password");
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        return this.getAuthenticationManager().authenticate(new PhonePasswordAuthenticationToken(phonePasswordLoginForm.getPhone(), phonePasswordLoginForm.getPassword(), UserTypeConstant.CANDIDATE));
    }
}
