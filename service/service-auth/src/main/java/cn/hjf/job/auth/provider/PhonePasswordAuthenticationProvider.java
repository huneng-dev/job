...
public class PhonePasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    @Resource
    private PhonePasswordUserDetailsService phonePasswordUserDetailsService;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        // 获取参数
        PhonePasswordAuthenticationToken phonePasswordAuthenticationToken
                = (PhonePasswordAuthenticationToken) authentication;
        String phone = phonePasswordAuthenticationToken.getPhone();
        String password = phonePasswordAuthenticationToken.getPassword();
        Integer userType = phonePasswordAuthenticationToken.getType();
        ...
        UserDetails userDetails = phonePasswordUserDetailsService.loadUserByPhoneAndUserType(phone, userType);
