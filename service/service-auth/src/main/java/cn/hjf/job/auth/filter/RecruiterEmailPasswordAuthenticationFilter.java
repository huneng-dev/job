...
public class RecruiterEmailPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {

    private final ValidationUtil validationUtil;


    public RecruiterEmailPasswordAuthenticationFilter(
        ...
        super.setFilterProcessesUrl("/auth/recruiter/email/password");
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        return this.getAuthenticationManager().authenticate(new EmailPasswordAuthenticationToken(emailPasswordLoginForm.getEmail(), emailPasswordLoginForm.getPassword(), UserTypeConstant.RECRUITER));
    }
}
