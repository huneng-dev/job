...
@Component
public class PhonePasswordUserDetailsService implements UserDetailsService {
     ...
     * @return UserDetails
     */
    public UserDetails loadUserByPhoneAndUserType(String phone, Integer userType) throws UsernameNotFoundException {
        // 获取用户信息
        Result<UserInfoPasswordStatus> result = getUserInfoPasswordStatusByPhonePassword(phone, userType);
     ...
     * 获取用户信息（手机号密码方式）
     */
    private Result<UserInfoPasswordStatus> getUserInfoPasswordStatusByPhonePassword(String phone, Integer userType) {
        Result<UserInfoPasswordStatus> result = userInfoFeignClient.getUserInfoPasswordStatusByPhonePassword(phone, userType, keyProperties.getKey());
